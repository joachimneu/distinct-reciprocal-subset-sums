...
Machine-generated tight contribution lemmas `shell_tight_20`..`shell_tight_38`, cloning the proven three-shell template of `HighShellTight.lean` (`shell_contribution_ge_tight`).
