...
Machine-generated tight contribution lemmas `shell_tight_115`..`shell_tight_134`, each a clone of the proven per-shell template `shell_contribution_ge_tight` from `HighShellTight.lean`.
