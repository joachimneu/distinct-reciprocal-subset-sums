...
Machine-generated (`gen_shells.py`) tight contribution lemmas `shell_tight_58`..`shell_tight_76`, cloning the proven three-shell template of `HighShellTight.lean` (`shell_contribution_ge_tight`).
