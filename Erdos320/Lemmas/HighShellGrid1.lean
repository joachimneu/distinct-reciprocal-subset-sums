...
Machine-generated tight contribution lemmas `shell_tight_1`..`shell_tight_19`, cloning the proven three-shell template of `HighShellTight.lean` (`shell_contribution_ge_tight`).
